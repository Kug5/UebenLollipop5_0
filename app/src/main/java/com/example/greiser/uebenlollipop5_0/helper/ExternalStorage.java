...
public class ExternalStorage {
  ...
  public File getTasksFile(Context context, String operation, int max, String name) {
    ...
    return new File(
        ...
        this.getFileName(operation, max, name));
  }

  public void storeTasks(
      Context context, StorageData storedData, String operation, int max, String name)
      throws IOException {
  ...
  public File getFileListOfNames(Context context) {
    return new File(
        context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), getFileNameListOfNames());
  }
  ...
  public File getFileSettings(String name, Context context) {
    return new File(
        context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), getFileNameSettings(name));
  }
  ...
  public void storeSettings(Context context, UserSetting usersettings, String name)
      throws IOException {
  ...
  public StorageData getStoredTasks(Context context, String operation, int max, String name)
      throws Exception {
  ...
  public void storeHeightScores(Context context, String name, UserHeightScore userHeightScore)
      throws IOException {
  ...
  public File getHeightScoreFile(Context context, String name) {
    // Get the directory for the app's private pictures directory.
    return new File(
        context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "hs" + name + ".txt");
  }
  ...
  private File getDeutschFileName(Context context) {
    ...
    return new File(
        context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "deutschVorlagen.txt");
  }
  ...
  public String getImageFilePath(Context context, String singular) {
    return new File(context.getExternalFilesDir(Environment.DIRECTORY_PICTURES), singular + ".png")
        .getAbsolutePath();
  }
